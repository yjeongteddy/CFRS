function PostSetup_home(tgt_tc, tgt_NPP, intensity, int_inc, rpath)
...
if nargin < 4, int_inc   = '30.17%'; end
if nargin < 5, rpath     = 'S:/home/user_006/01_WORK/2025/NPP'; end
...
switch tgt_NPP
    ...
    case 'HANBIT'
        COAST = load('S:/home/user_006/03_DATA/YG_coastline_220218.mat').YG;
        blon = 126.39; ulon = 126.42; blat = 35.40; ulat = 35.42;
end
...
clim([0 50]); xlim([blon ulon]); ylim([blat ulat]);
