function PrepWaveSetup_v2(tgt_tc, tgt_NPP, SeaLevel, rpath)
...
wpath_w = fullfile(dpath, tgt_tc, '10_SWAN', [subdir '_mod']);
wpath_s = fullfile(dpath, tgt_tc, '13_SETUP', [subdir '_mod']);
