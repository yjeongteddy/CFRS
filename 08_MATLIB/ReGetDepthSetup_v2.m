function ReGetDepthSetup_v2(tgt_tc, tgt_NPP, SeaLevel, rpath)
...
wpath_a = fullfile(dpath, tgt_tc, '12_ADCIRC', [subdir '_mod']);
...
tgt_dth = load(fullfile(dpath, [SeaLevel '_mod'], [SeaLevel '.mat']));
...
fgs = grd_to_opnml(fullfile(dpath, [SeaLevel '_mod'], 'fort.14'));
